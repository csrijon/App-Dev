...
const OrderSuccessScreen = ({ navigation }) => {
    ...
    const handleShareOrder = async () => {
        ...
        try {
            ...
            Alert.alert(
                "Error",
                "Unable to share order details right now."
            );
            ...
            [
                {
                    text: "Call Us",
                    onPress: () =>
                        Linking.openURL("tel:+917029046473")
                },
                {
                    text: "WhatsApp Chat",
                    onPress: () =>
    ...
    return (
        ...
        <SafeAreaView style={styles.ordersuccesscontainer}>
            ...
            <ScrollView
                ...
                style={styles.ordersuccessscroll}
            >
                ...
                <View style={styles.odersuccessdetalis}>
                    ...
                    >
                        Thank you for choosing Cake Haven.Your sweet treats are on the way!
                    </Text>
