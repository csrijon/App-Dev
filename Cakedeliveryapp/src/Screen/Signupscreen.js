...
const Signupscreen = ({ navigation }) => {
    ...
    const isMobileValid = fullmobile.trim().length === 10 && /^[0-9]+$/.test(fullmobile)
                    ...
                    <View style={styles.signupform} >
                        ...
                        <View style={styles.signupforminput} >
                            ...
                            <View style={{ flexDirection: "row", gap: 8, alignItems: "center" }}>
                                <View style={[styles.inputcontainer, focusedField === "mobile" && styles.inputFocused, { flex: 1, marginLeft: 0, flexDirection: "row", alignItems: "center", gap: 6, paddingHorizontal: 10 }]} >
                                    <TouchableOpacity onPress={() => setShowCountryDropdown(prev => !prev)} style={{ paddingHorizontal: 4 }}>
                                        <Text style={{ fontWeight: "700", color: "#5A3E2B", fontSize: 13 }}>{countryCode} ▼</Text>
                                    </TouchableOpacity>
                                    {showCountryDropdown && (
                                        <View style={{ position: "absolute", top: 42, left: 10, backgroundColor: "#fff", borderRadius: 12, borderWidth: 1, borderColor: "#E9E2D8", padding: 8, shadowColor: "#000", shadowOpacity: 0.1, shadowRadius: 8, elevation: 5, zIndex: 10, minWidth: 160 }}>
                                            {countries.map((c) => (
                                    ...
                                    <FontAwesome style={styles.iconcolor} name="mobile-phone" color="#A67C52" size={18} />
                                    <TextInput
