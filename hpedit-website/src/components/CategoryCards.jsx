...
export default function CategoryCards() {
  return (
    <section style={{ background:'#fff', padding:'60px 0 40px' }}>
      <div className="container" style={{ overflowX:'auto', scrollbarWidth:'none' }}>
        <div style={{ display:'flex', gap:16, minWidth:'max-content' }}>
          {cats.map(c=> (
            <a href="#" key={c.name} style={{ textDecoration:'none', position:'relative', width:220, height:300, borderRadius:24, overflow:'hidden', flex:'0 0 auto', boxShadow:'0 8px 24px rgba(74,29,122,0.12)', display:'block' }}>
...
<style>{`@media (max-width: 640px) { a { width: 160px !important; height: 220px !important; } }`}</style>
