  ...
  return (
    <section style={{ background: 'linear-gradient(180deg, #f3ecfb 0%, #fff 70%)', padding: '100px 0 60px' }}>
      <div className="container" style={{ display:'grid', gridTemplateColumns:'1fr 1.1fr', gap:60, alignItems:'center' }}>
        <div>
          <h2 style={{ fontFamily:"'Caveat', cursive", fontSize:'2rem', color:'var(--purple)', lineHeight:1.1, marginBottom:20, fontWeight:700 }}
            className="Handwritten">Creators<br/>Build<br/>Brighter<br/>Worlds ♡</h2>
          <h1 style={{ fontSize:'clamp(2.6rem, 5vw, 4.2rem)', fontWeight:900, letterSpacing:'-0.05em', color:'var(--text-dark)', lineHeight:1.05, marginBottom:16 }}>
            Turn Your Passion Into A<br/>
            <span style={{ color:'var(--purple-deep)', position:'relative' }}>Beautiful<br/>Online Home</span>
          </h1>
          <p style={{ fontSize:'1.15rem', color:'var(--text-body)', maxWidth:480, marginBottom:28 }}>Stunning portfolio websites for creators, by creators.</p>
        ...
        <div style={{ position:'relative' }}>
          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=800&q=80" alt="Creator" style={{ borderRadius:32, width:'100%', boxShadow:'0 30px 60px rgba(74,29,122,0.18)', objectCover:'cover', height:520 }} />
          {/* floating cards */}
